...
class DataRange():
    def __init__(self, data:pd.DataFrame, plotting_style:dict = {}, name:str='data'):
    ...
    @staticmethod
    def from_file(file_path, **params_to_pass):
        """
        ...
        return DataRange(df, **params_to_pass)

class ReferenceData(DataRange):
    """
    Custom class for ref data (different format to case data)
    """
    def __init__(self, path_to_file, plotting_style:dict=REFERENCE_PLOTTING_STYLE, name:str='reference'):
        ...
        # TODO: make the keys more gooder less badder
...
class CaseResults():
    ...
    def __data_fill_helper(self, dir_path, **params_to_pass):
        """
        ...
        for root, _, files in os.walk(dir_path):
            for file_name in files:
                ...
                data_instance = DataRange.from_file(file_path, name = name, **params_to_pass)
